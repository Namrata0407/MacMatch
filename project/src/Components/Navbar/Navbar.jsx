...
const DesktopNav = () => {
  ...
  const products =[
    ...
    },
    {
      ...
      "rating": 4.1,
      "cartStatus": false,
      "description": "Apple 2022 MacBook Pro Laptop with M2 chip: 33.74 cm (13.3-inch) Retina Display, 8GB RAM, 256GB SSD ​​​​​​​Storage, Touch Bar, Backlit Keyboard, FaceTime HD Camera​​​ Space Grey​​​​​​​"
    },
    {
      "id": 6,
    ...
    },
    {
      ...
      "rating": 4.6,
      "cartStatus": false,
      "description": "The device was available initially with three storage sizes – 16, 32, and 64 GB[8][3] – and two varying connectivity options"
    },
    {
      "id": 11,
      "title": "iPad mini",
    ...
    },
    {
      ...
      "rating": 3.9,
      "cartStatus": false,
      "description": "The iPhone is a series of smartphones made by Apple Inc since 2007. It is a mobile phone, meaning that it makes calls and sends text messages without wires. There are many types of iPhones, such as the main models and others, such as the mini or pro editions."
    },
    {
      "id": 14,
  ...
  const throttledText = useThrottle(query, 10);
          ...
          {suggation.map((item) => {
            return (
              <Link
                ...
                to={`/product/${item.id}`}
              >
                <Text color={'whiteAlpha.700'} cursor={"pointer"}>{item.title}</Text>
              </Link>
            );
          })}
        </Box>
