...
import { getAdminDataProduct, ordersAdminData } from "../../Redux/AdminRedux/admin.action";
...
// console.log(totalPrice)
    return (
        <>
           ...
           <Heading textAlign={"start"}>Product Price</Heading>
            ...
            <Box border={"5px solid #023e8a"} maxHeight={"500px"} overflow="scroll" display={"flex"} width={"56%"} >
                <TableContainer>
                <Heading textAlign={"start"} fontSize={"40px"} color={"grey"}>Price Detail</Heading>
 ...
 {/* <Td> <Flex gap={"10px"} > <AdminShowProductModal /> <AdminEditProductModal /> <AdminDeleteProductModal/> </Flex> </Td> */}
            ...
            <Flex  bg={"#023e8a"} color={"white"} width={"56%"} justifyContent={"center"} textAlign={"center"} >  
                    <Text padding={"10px"}>Total Price Summary :- {"₹ "}{totalPrice}</Text>    
